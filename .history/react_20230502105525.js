...
composant soit rendu. Il peut s'agir d'un élément HTML existant dans le DOM, ou d'un élément HTML que vous avez créé dynamiquement à l'aide de JavaScript.
