...
requete.responseType = "json";
requete.send("prenom=John"); //Envoyer la requête, si on doit renvoyer plusieurs informations comme prénom + nom, on doit faire avec & et sans espaces entre les infos:prenom=John&n
