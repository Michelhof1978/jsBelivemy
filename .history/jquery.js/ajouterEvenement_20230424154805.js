...
$('p').click(() => {
  ...
  $('h1').on('mouseover', () => {//L'événement "on" en jQuery est une méthode qui permet de lier un ou plusieurs événements à un élément HTML sélectionné, et d'exécuter une fonction lorsque l'événement se produit.
