...
if ('geolocation' in navigator) {
    ...
    function error() {//Au cas où l utilisateur refuse d être géocalisé pour afficher une alert mais en général, on ne fait pas d alert, uniquement, on désactive automatiquement la position 
