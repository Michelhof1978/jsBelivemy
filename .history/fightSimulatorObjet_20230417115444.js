...
// Maintenant, il suffit d'initialiser nos objets. Je vous recommande de définir un personnage comme magicien et un autre comme guerrier, vous pourrez ainsi voir le fruit de vos efforts récompensé en voyant toutes les subtilités que vous avez créé dans vos méthodes !
...
class Personnage {
  ...
  class Magicien extends Personnage {//La class magicien hérite de la class personnage, ne pas oublier de mettre la première lettre d une class en majuscule
    constructor(pseudo) {
      super(pseudo, "magicien", 170, 90);//Le mot-clé super est utilisé afin d'appeler ou d'accéder à des fonctions définies sur l'objet parent. Les expressions de la forme super. propriete et super[expr] sont valides pour n'importe quelle définition de méthode, que ce soit au sein d'une classe ou d'un littéral objet
    }
