...
`param1`, `param2`, et `rest`. Les deux premiers paramètres sont des paramètres normaux qui doivent être fournis lors de l'appel de la fonction, tandis que le troisième paramètre (`rest`) est un paramètre de reste qui récupère tous les autres arguments.
