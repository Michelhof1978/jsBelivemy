...
letPlusGrandQue10 = prices.filter(function(p){//On stocke notre fonction anonyme la variable p et on utilise pour tous les prix(prices) la fonction filter pour filtrer
    return p > 10
});
