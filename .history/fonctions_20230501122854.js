...
letPlusGrandQue10 = prices.filter(function(p){//On stocke notre fonction anonyme la variable p et on utilise pour tous les prix(prices) la fonction filter pour filtrer, trier les prix
    return p > 10//Si c'est true, on stocke le prix ds la variable letPlusGrandQue10
});
