...
let monAutreObjet = {...monObjet}; //Créer une copie avec REST parameter), javascript va copier toutes les valeur
console.log(monAutreObjet.voiture);//résultat tesla

//Modifie??
monObjet.voiture = "toyota";
console.log('monAutreObjet :' + monObjet.voiture);//résultat tesla
