...
//ON ne peut pas copier un type par reference IMPORTANT A SAVOIR !!!! Il faut créer une véritable copie en utilisant le REST parameter
Exemple:
...
console.log(monAutreObjet.voiture);//résultat tesla //LES 3 PETITS POINT= SPRAID OPERATEUR
