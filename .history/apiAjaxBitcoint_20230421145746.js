  //A EVITER D UTILISER CODE CI DESSOUS? 
  
  const url = 'https://blockchain.info/ticker';

  function recupererPrix() {
    // Créer une requête AJAX qui est un objet
    ...
    requete.onload = function() {
          ...
          let prixEnEuros = reponse.EUR.last;//Récupérer le dérnier prix en euros du fichier Json
          document.querySelector('#price_label').textContent = prixEnEuros;//On récupére via l id et on l affiche à lécran
        }
        else {
  ...
  setInterval(recupererPrix, 1000);//Pour éviter de rafraichir constemment la page pour voir l évolution du bitcoin, on rafraichi la page toutes les 1 seconde