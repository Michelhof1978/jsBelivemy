...
export direBonjour(prenom) {
  ...
  // index.js
  import { direBonjour } from './modules/direBonjour.js';//on utilise uniquement les acolades { direBonjour } quand on a besoins d une fonction ou d'un objet bien précis
