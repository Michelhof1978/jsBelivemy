import React,{ Component} from 'react';//On doit importer l objet component la librairie React pour pouvoir créer un composant du site
import './App.css';
...
class App extends React.Component {//On va créer un composant App et on hérite (extends) du composant de l'objet React
