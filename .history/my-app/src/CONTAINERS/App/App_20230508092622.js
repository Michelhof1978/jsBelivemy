...
et le démontage du composant. Le tableau de dépendances contient deux variables, "variable1" et "variable2", qui seront surveillées pour déclencher l'exécution de la fonction callback.
