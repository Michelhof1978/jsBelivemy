...
Le composant "Eleve" est appelé avec des propriétés passées en paramètres, dans ce cas "nom", "moyenne" et
 ...
 "eleves" (c'est-à-dire l'objet représentant le deuxième élève). La propriété "clic" est définie en passant une fonction fléchée qui appelle une méthode "buttonClickedHandler" avec le paramètre "nicolas".
