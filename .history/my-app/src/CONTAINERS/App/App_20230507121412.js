  ...
  shouldComponentUpdate(nextProps, nextState) {
   ...
   systématique de cette méthode peut empêcher certaines mises à jour nécessaires de se produire, ce qui peut entraîner des erreurs ou des problèmes dans l'application. Par conséquent, il est important de bien comprendre l'utilisation de cette méthode et de l'utiliser avec précaution.
    ------------------------------------------------------------------------------------------------------------
