...
composant.Plus précisément, useEffect() est utilisé pour exécuter des effets de bord (side effects) dans les composants React, comme par exemple les appels à des API externes, la manipulation du DOM, la gestion des abonnements et des timers, etc.
