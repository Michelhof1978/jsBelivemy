  ...
  <h1>BIENVENUE MIMICHE</h1>//On appele ce code du sucre syntaxique = JSX, pour écrire plus facilement du Js
   ...
   <button onClick = {this.buttonClickedHandler}> Mon bouton </button>//Comme ce n'est pas du js mais du jsx et que l on veut créer un événement, il suffir juste de mettre la majuscule à onClick
