  ...
  eleves: [//On crée un tableau d'objets et ds chaque tableau, il y aura un object javascript
    ...
    buttonClickedHandler = () => {//Fonction pour le bouton ci dessous, grâce à elle, l événement se déclanchera lors du clic sur bouton, s il n'y avait pas cette fonction le jsx lancera le js qui est à l intérieur de lui automatiquement
      console.log('clic')
    }
