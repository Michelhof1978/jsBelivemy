...
Le premier hook "useState" permet de définir un état "eleves" qui est un tableau d'objets représentant des élèves,
 avec les propriétés "nom", "moyenne" et "citation". La valeur initiale de l'état est définie comme un tableau avec deux éléments. Cet état peut être mis à jour avec la fonction "setEleves", qui prend un nouveau tableau d'objets en paramètre.
