...
Le deuxième hook "useState" permet de définir un état "maintenance" qui est un booléen représentant l'état de
 maintenance de l'application. La valeur initiale de l'état est définie comme "false". Cet état peut être mis à jour avec la fonction "setMaintenance", qui prend un nouveau booléen en paramètre.
