...
composant a été monté, telles que la récupération de données à partir d'une API, la configuration d'événements, la mise en place de timers, ou la modification de l'état du composant.
