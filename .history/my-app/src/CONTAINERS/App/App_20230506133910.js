  ...
  eleves: [//On crée un tableau d'objets et ds chaque tableau, il y aura un object javascript
    ...
    buttonClickedHandler = () => {//Fonction pour le bouton ci dessous, grâce à elle, l événement se déclanchera lors du clic sur bouton, s il n'y avait pas cette fonction le jsx lancera le js qui est à l intérieur de lui automatiquement, ce qui poserait problè
      console.log('clic')
    }
  ...
  <h1>BIENVENUE MIMICHE</h1>//On appele ce code du sucre syntaxique = JSX, pour écrire plus facilement du Js
   ...
   <button onClick = {console.log('clic')}> Mon bouton </button>//Comme ce n'est pas du js mais du jsx et que l on veut créer un événement, il suffir juste de mettre la majuscule à onClick
