...
-----------------------------------------------------------------------------------------------------
  state = {//State est un object React qui permet de gérer les données,c'est un type par référence, le but du state est de regrouper toutes les informations ds un seul endroit
