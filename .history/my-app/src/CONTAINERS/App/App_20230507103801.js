  ...
  return (
   ...
   //Pour appeler buttonClickedHandler et pour que ça fonctionne, on ne mets pas de parenthèse sinon ça va poser un problème */}
     ...
     <Eleve nom = {this.state.eleves[0].nom} 
            ...
            clic = {this.buttonClickedHandler}// Clic = ma méthode, !!!!!Surtout ne pas mettre de parenthèse quand on appelle la méthode sinon, le code va s'éxectuter automatiquement alors que l on souhaite 
