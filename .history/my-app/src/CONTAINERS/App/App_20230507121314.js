  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    return false;
  }//La méthode "shouldComponentUpdate" est une méthode du cycle de vie des composants React qui permet de contrôler si un composant doit être mis à jour ou non. Cette méthode est appelée avant que le composant ne soit mis à jour et prend en deux paramètres : nextProps et nextState qui représentent respectivement les prochaines props et l'état suivant du composant.
