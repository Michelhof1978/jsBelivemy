...
--------------------------------------------------------------------------------------------------------------------
  return (
   ...
   <button onClick = {this.buttonClickedHandler.bind(this, 'Elina')}>Modification nom eleve</button>/*//ON NE METS PAS DE PARENTHESE ATTENTION, ON veut juste passer une reference par cette fonction, il faudra insérer bind avec ses paramétres this pour pouvoir changer de nom//Comme ce n'est pas du js mais du jsx et que l on veut créer un événement, il suffir juste de mettre la majuscule à onClick, comme c'est une class, on ajoute this pour appeler la fonction buttonClickedHandler
