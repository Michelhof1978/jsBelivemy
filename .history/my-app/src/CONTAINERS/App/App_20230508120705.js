...
//Effet de bord = Les effets de bord en informatique se réfèrent à des changements ou des actions qui se produisent dans un système en dehors de l'environnement contrôlé par une fonction ou un programme. En d'autres termes, ce sont des effets indirects qui ne sont pas prévus ou prévisibles lorsque le code est exécuté. Les effets de bord peuvent être intentionnels ou non, et ils peuvent avoir des conséquences imprévues sur le système.

Les exemples courants d'effets de bord incluent les interactions avec des fichiers ou des bases de données, les entrées/sorties, l'envoi de requêtes réseau, la modification de variables globales, la modification du contenu du presse-papiers, etc.
...
Cependant, dans des langages de programmation impératifs comme C ou C++, les effets de bord sont courants et sont souvent nécessaires pour interagir avec le monde extérieur. Dans les langages de programmation fonctionnelle comme Haskell, les effets de bord sont isolés dans des monades pour faciliter leur gestion et les rendre plus prévisibles.