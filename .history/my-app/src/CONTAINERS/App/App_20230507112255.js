  ...
  return (
   ...
   //Pour appeler buttonClickedHandler et pour que ça fonctionne, on ne mets pas de parenthèse sinon ça va poser un problème */}
     ...
     <Eleve nom = {this.state.eleves[0].nom} 
            ...
            clic = {() => this.buttonClickedHandler()}//On va executer une fonction anonyme et Quand on cliquera sur le nom, le nom va changer, Clic = ma méthode, tre de parenthèse quand on appelle la méthode sinon, le code va s'éxectuter automatiquement alors que l on souhaite qu'il s execute lors du clic sur bouton
