...
const [eleves, setEleves] = useState([
  ...
  Par exemple, si "maintenance" est défini sur "true", l'application peut afficher un message de maintenance ou empêcher les utilisateurs d'effectuer certaines actions.
  c
