  ...
  Cette méthode est souvent utilisée pour effectuer des tâches qui doivent être effectuées après que le composant
   a été mis à jour, telles que la mise à jour des données d'un composant enfant, la modification de l'état du composant en fonction des nouvelles props ou de l'ancien état, ou la mise à jour de l'interface utilisateur en fonction des nouvelles données.
