...
//1ère solution pour créer un composant
...
const App = () => {//Toujours mettre const pour un composant, un composant ne sera jamais modifié, juste modifié mais dynamyquement
