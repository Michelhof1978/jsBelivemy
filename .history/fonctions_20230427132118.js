...
//L ordinateur va d'abords chercher toutes les fonctions déclaréés et le garder en mémoire avant d'executer tout le code js 
function direBonjour(prenom){
  console.log('Bonjour'+ prenom);
}

//EXPRESSION DE FONCTION, C'est une fonction qui pourra être appellé en local
