...
------------------------------------------------------------------------------------------------
GERER LA PROPAGATION DES EVENEMENTS AVEC JS 
...
// setTimeout function, s affiche que 3 secondes
let timer = setTimeout("alert('Bonjour')", 3000);
clearTimeout(timer);//Arrêter le timer

// setInterval function, s affiche toutes les 5 secondes lors du clic
let interval = setInterval("alert('Bonjour')", 5000);
clearInterval(interval);// Arrêtter
----------------------------------------------------------------------------------------------------------------------------------------------------
