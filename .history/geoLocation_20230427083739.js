...
if ('geolocation' in navigator) {
    ...
    navigator.geolocation.getCurrentPosition((position) => {//On récupére l objet geolocation ds le navigateur et en cas de succés on récupére la position avec la fonction anonyme
