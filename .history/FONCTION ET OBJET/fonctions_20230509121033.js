...
const mapedArr = arr.map(x => x + 10);//Retourne un nouveau tableau grâce à map, il remplacera le [1,2,3,4,5,6] en ajoutant 10 à chaque données du tableaupar [11,12,13,14,15,16]