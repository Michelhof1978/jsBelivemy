...
const mapedArr = arr.map(x => x + 10);//Retourne un nouveau tableau grâcRésultat: [11,12,13,14e à map, il remplacera le [1,2,3,4,5,6] en ajoutant 10 à chaque données du tableau. ,15,16]
