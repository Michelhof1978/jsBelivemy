...
// Le paramètre rest est une fonctionnalité utile qui permet aux développeurs de créer des fonctions plus flexibles et génériques qui peuvent accepter un nombre variable d'arguments.
 ---------------------------------------------------------------------------------------------------------------------------------------------------------
 //FONCTION IMPURE, NE PAS FAIRE CAR CHAQUE FOIS QUE L ON VA L APPELER, CA RAJOUTERA 4 A LA SOMME A CHAQUE FOIS
 let x = 2;
 ...
 ----------------------------------------------------------------------------------------------------------------
 //FONCTION PURE, LE CODE VA TOUJOURS RETOURNER 4
 let x = 2;
 const add2 = (a,b) => a + b;
